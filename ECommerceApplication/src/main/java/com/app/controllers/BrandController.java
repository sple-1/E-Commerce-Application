...
public class BrandController {
	...
	public ResponseEntity<BrandDTO> updateBrandLogo(@PathVariable Long brandId, @RequestParam("logo") MultipartFile logo) throws IOException {
		BrandDTO brandDTO = brandService.updateBrandLogo(brandId, logo);
